...
## Exercise - 1 Integrate with ACR

- Create new repository `devops-lab09`, and copy every files from this repository to your repository
...
Assign the values from the values from spreadsheet.
...
- Commit and Push the code, go to GitHub UI to see how your workflow is running
